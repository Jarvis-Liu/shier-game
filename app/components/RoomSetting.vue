...
<template>
  <div class="flex-1 flex flex-col items-center justify-center p-4">
    <div class="w-full max-w-2xl flex flex-col md:flex-row gap-8">
      <!-- 选手设置区 (非观众) -->
      <div v-if="!isSpectator" class="flex-1 sketch-box p-6 bg-white/60 relative">
      ...
      <!-- 观众观战区 -->
      <div v-else class="flex-1 sketch-box p-12 bg-white/40 flex flex-col items-center justify-center text-center space-y-6 border-dashed">
        <div class="w-16 h-16 rounded-full bg-pencil-grey/10 flex items-center justify-center">
          <UIcon name="i-lucide-eye" class="w-8 h-8 text-pencil-grey animate-pulse" />
        </div>
        <div>
          <h3 class="text-xl font-bold text-pencil-grey">正在观战</h3>
